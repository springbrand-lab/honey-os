...
def _auto_title_enabled() -> bool:
    ...
    try:
        ...
        # from honeyos.agent code paths where a module-level honeyos.runtime import risks
...
def auto_title_session(
    ...
    post-``honeyos update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running HoneyOS process): %s",
            e,
        )
...
def _auto_title_session(
    ...
    from honeyos.agent.aux_accounting import set_accounting_context
    from honeyos.agent.portal_tags import set_conversation_context
