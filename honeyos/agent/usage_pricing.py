...
from honeyos.agent.model_metadata import fetch_endpoint_model_metadata, fetch_model_metadata
...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models honeyos typically routes
