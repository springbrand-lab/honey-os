...
from honeyos.agent.tool_dispatch_helpers import make_tool_result_message
from honeyos.agent.tool_result_classification import tool_may_have_side_effect
...
def strip_dangling_tool_call_tail(
    ...
    ``systemctl restart``, ``kill``, ``honeyos gateway restart``), the process
    ...
    if any(
        ...
        for call in tool_calls:
            ...
            content = (
                "[Orphan recovery: this tool may have executed before HoneyOS stopped; "
