...
2. :func:`hatch_pet` — takes the chosen base and generates one grounded row
   strip per HoneyOS state, slices each into frames, composes the atlas, validates
...
from honeyos.agent.pet.generate import atlas, imagegen, prompts
from honeyos.agent.pet.generate.imagegen import GenerationError, SpriteProvider
...
def hatch_pet(
    *,
    ...
    """Turn an approved base image into a full, installed HoneyOS pet.
