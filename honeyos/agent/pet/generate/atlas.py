"""Deterministic spritesheet assembly — generated row strips → HoneyOS atlas.
...
from honeyos.agent.pet.constants import FRAME_H, FRAME_W
...
def compose_atlas(frames_by_state: dict[str, list]):
    """Pack per-state frame lists into the HoneyOS atlas (RGBA, residue-cleared).
