"""AWS Bedrock Converse API adapter for HoneyOS.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install HoneyOS with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When HoneyOS is installed editable into system Python, the system boto3
...
def probe_bedrock_context_length(model_id: str, region: str) -> Optional[int]:
    ...
    """
    try:
        from honeyos.agent.model_metadata import parse_context_limit_from_error
