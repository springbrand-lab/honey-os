...
See the ``honeyos-agent-dev`` skill (``references/self-improvement-loop.md``)
...
from honeyos.agent.thread_scoped_output import thread_scoped_silence
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with HoneyOS, e.g. 'honeyos-agent').\n"
    "  • Hub-installed skills (installed via 'honeyos skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'honeyos curator pin'). You are an "
    ...
    "'honeyos curator adopt <name>' — do not try to patch it.\n"
...
_COMBINED_REVIEW_PROMPT = (
    ...
    "  • Hub-installed skills (installed via 'honeyos skills install').\n"
    "  • Skills in skills.external_dirs (externally owned).\n"
    "  • PINNED skills (marked via 'honeyos curator pin'). Pin blocks "
    ...
    "reply and recommend 'honeyos curator adopt <name>' instead.\n"
    "If the only skills that need updating are protected, say\n"
    "'Nothing to save.' and stop.\n\n"
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("HONEYOS_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    from honeyos.tools.terminal_tool import set_approval_callback as _set_approval_callback
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _honeyos_now() timestamp, fresh
            ...
            from honeyos.runtime.plugins import (
            ...
            try:
                from honeyos.tools.skill_manager_tool import _reset_background_review_read_marks
