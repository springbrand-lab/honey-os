...
class FailoverReason(enum.Enum):
    ...
    llama_cpp_grammar_pattern = "llama_cpp_grammar_pattern"  # llama.cpp json-schema-to-grammar rejects regex escapes in `pattern` / `format` — strip from honeyos.tools and retry
...
#
# See: https://github.com/NousResearch/honeyos-agent/issues/27344
...
# case: a stream dies mid-response and HoneyOS persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    from honeyos.agent.errors import MoAPresetNotFoundError
