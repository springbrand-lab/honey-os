...
from honeyos.agent.transports.types import NormalizedResponse
...
class AnthropicTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        """
        from honeyos.agent.anthropic_adapter import convert_messages_to_anthropic
    ...
    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        ...
        from honeyos.agent.anthropic_adapter import convert_tools_to_anthropic
    ...
    def build_kwargs(
        ...
        **params,
        ...
        """
        from honeyos.agent.anthropic_adapter import build_anthropic_kwargs
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        """
        import json
        from honeyos.agent.anthropic_adapter import _to_plain_data, _sanitize_replay_block
        from honeyos.agent.transports.types import ToolCall
        ...
        for block in response.content:
            ...
            if block.type == "text":
                ...
                if strip_tool_prefix and name.startswith(_MCP_PREFIX):
                    ...
                    from honeyos.tools.registry import registry as _tool_registry
