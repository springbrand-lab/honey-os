...
from honeyos.agent.moonshot_schema import is_moonshot_model, sanitize_moonshot_tools
from honeyos.agent.prompt_builder import DEVELOPER_ROLE_MODELS
from honeyos.agent.transports.base import ProviderTransport
from honeyos.agent.transports.types import NormalizedResponse, ToolCall, Usage


def _normalize_text_response(response: str) -> NormalizedResponse:
    """Normalize gateways that return SSE text for a non-streaming request."""
    ...
    for payload in payloads:
        ...
        body = message if isinstance(message, dict) else delta
...
def _add_prompt_cache_key(
    ...
    *,
    ...
    from honeyos.agent.transports.codex import _cache_scope_from_session_id, _content_cache_key
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate HoneyOS/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from HoneyOS'
    ...
    # is stricter (low/high). Clamp HoneyOS' wider effort set to what each
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - HoneyOS-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all HoneyOS-internal scaffolding markers (``_``-prefixed).
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        """
        from honeyos.providers.base import OMIT_TEMPERATURE
