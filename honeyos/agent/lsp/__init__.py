"""Language Server Protocol (LSP) integration for HoneyOS.

HoneyOS runs full language servers (pyright, gopls, rust-analyzer,
...
from honeyos.agent.lsp.manager import LSPService
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``honeyos chat`` exit would leak pyright processes that
