...
from honeyos.agent.lsp import eventlog
from honeyos.agent.lsp.client import (
    DIAGNOSTICS_DOCUMENT_WAIT,
    LSPClient,
)
from honeyos.agent.lsp.servers import (
    ServerContext,
    find_server_for_file,
    language_id_for,
)
from honeyos.agent.lsp.workspace import (
    clear_cache,
...
class LSPService:
    ...
    def create_from_config(cls) -> Optional["LSPService"]:
        """Build a service from ``honeyos.runtime.config`` settings.
    ...
    def enabled_for(self, file_path: str) -> bool:
        ...
        timeout cost — until the service is restarted (``honeyos lsp
        ...
        if delta:
            ...
            if baseline:
                if line_shift is not None:
                    ...
                    from honeyos.agent.lsp.range_shift import shift_baseline
    ...
    # ------------------------------------------------------------------
    # status / introspection (used by ``honeyos lsp status``)
    # ------------------------------------------------------------------
