"""Core NeMo Relay adapter for HoneyOS tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the HoneyOS tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous HoneyOS Relay tool execution cannot run on an active event-loop thread"
    )
