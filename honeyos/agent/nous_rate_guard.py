...
(3 SDK retries x 3 HoneyOS retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_honeyos_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".honeyos")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, HoneyOS, ...) behind one endpoint.  A 429 can mean either:
