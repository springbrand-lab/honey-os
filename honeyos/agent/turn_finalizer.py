...
decomposition campaign (``~/.honeyos/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    """
    from honeyos.agent.conversation_loop import logger
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("HONEYOS_KANBAN_TASK")
        if _kanban_task:
            try:
    ...
    try:
        ...
        if interrupted:
            from honeyos.agent.message_sanitization import close_interrupted_tool_sequence
    ...
    try:
        from honeyos.agent.conversation_loop import _notify_context_engine_turn_complete
    ...
    result = {
        ...
        # billing audits by callers like `honeyos -z --usage-file`.
        "service_tier": (
