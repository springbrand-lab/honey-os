...
from honeyos.gateway.platforms.base import BasePlatformAdapter as _BasePlatformAdapter
from honeyos.gateway.platforms.base import _custom_unit_to_cp
from honeyos.gateway.platforms.base import MEDIA_TAG_CLEANUP_RE
from honeyos.gateway.config import (
    DEFAULT_STREAMING_EDIT_INTERVAL as _DEFAULT_STREAMING_EDIT_INTERVAL,
    DEFAULT_STREAMING_BUFFER_THRESHOLD as _DEFAULT_STREAMING_BUFFER_THRESHOLD,
    DEFAULT_STREAMING_CURSOR as _DEFAULT_STREAMING_CURSOR,
)
from honeyos.gateway.response_filters import (
...
class GatewayStreamConsumer:
    ...
    def _balance_fences_across_chunks(chunks: "list[str]") -> "list[str]":
        ...
        """
        from honeyos.gateway.platforms.helpers import balance_fences_across_chunks
    ...
    def _split_text_chunks(
        ...
        """
        from honeyos.gateway.platforms.helpers import split_text_fence_aware
    ...
    async def _send_commentary(self, text: str) -> bool:
        ...
        try:
            ...
            # multiple tool calls. See: https://github.com/NousResearch/honeyos-agent/issues/10454
            if result.success:
    ...
    def _adapter_prefers_fresh_final(self, text: str) -> bool:
        ...
        currently renders richer markdown than HoneyOS' MarkdownV2 edit path.
