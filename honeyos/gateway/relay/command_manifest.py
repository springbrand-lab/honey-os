...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your HoneyOS session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show HoneyOS session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running HoneyOS agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update HoneyOS to the latest version"},
        {"name": "restart", "description": "Gracefully restart the HoneyOS gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a HoneyOS session in it",
