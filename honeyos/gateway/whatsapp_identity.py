...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$HONEYOS_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_honeyos_dir("platforms/whatsapp/session", "whatsapp/session")
