...
from honeyos.gateway.platforms import helpers as _mdchunk
from honeyos.gateway.platforms.helpers import MessageDeduplicator
from honeyos.gateway.platforms.yuanbao_media import (
...
from honeyos.gateway.platforms.yuanbao_proto import (
    CMD_TYPE,
    _fields_to_dict,
    _get_string,
    _get_varint,
...
_APP_VERSION = _HONEYOS_VERSION
_BOT_VERSION = _HONEYOS_VERSION
_YUANBAO_INSTANCE_ID = str(HONEYOS_INSTANCE_ID)  # single source: yuanbao_proto.HONEYOS_INSTANCE_ID
        ...
        if not adapter._auto_sethome_done and adapter._sender_may_designate_home(ctx):
            ...
            if _should_set:
                try:
                    ...
                    from honeyos.runtime.config import atomic_config_write, read_user_config_raw
...
class StickerHandler(MediaSendHandler):
    ...
    def build_msg_body(self, upload_result, **kwargs):
        from honeyos.gateway.platforms.yuanbao_sticker import (
            get_sticker_by_name,
            get_random_sticker,
            build_face_msg_body,
...
class GroupQueryService:
    ...
    async def query_group_info_raw(self, group_code: str) -> Optional[dict]:
        ...
        from honeyos.gateway.platforms.yuanbao_proto import decode_conn_msg as _decode
