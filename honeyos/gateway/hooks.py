...
Hooks are discovered from ~/.honeyos/hooks/ directories, each containing:
...
HOOKS_DIR = get_honeyos_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"honeyos_hook_{hook_name}"
