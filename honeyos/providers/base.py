...
def _profile_user_agent() -> str:
    """Return a ``honeyos-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from honeyos.runtime import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"honeyos-cli/{_ver}"
    except Exception:
        return "honeyos-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # honeyos-cli UA so the catalog endpoint is reachable.
