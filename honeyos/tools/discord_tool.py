...
Only included in the honeyos-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "HoneyOS-Agent (https://github.com/NousResearch/honeyos-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_honeyos_home() / "cache" / "discord_capabilities.json"
