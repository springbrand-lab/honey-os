...
the get_anchored_view / get_messages_around primitives in honeyos.core.state.
...
# Third-party integrations tag their sessions with HONEYOS_SESSION_SOURCE=tool;
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from honeyos.core.state import _default_db_path
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches HoneyOS conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. HoneyOS renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about HoneyOS conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another HoneyOS profile's database "
