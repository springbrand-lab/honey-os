...
Trust levels:
  - builtin:   Ships with HoneyOS. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.honeyos/\.env|\~/\.honeyos/\.env',
     "honeyos_env_access", "critical", "exfiltration",
     "directly references HoneyOS secrets file"),
    ...
    (r'\.honeyos/config\.yaml|\.honeyos/SOUL\.md',
     "honeyos_config_mod", "critical", "persistence",
     "references HoneyOS configuration files directly"),
...
# scan. `.skillignore` is the HoneyOS-native name; `.clawhubignore` is honored
