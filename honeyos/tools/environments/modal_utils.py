"""Shared HoneyOS-side execution flow for Modal transports.

This module deliberately stops at the HoneyOS boundary:
- command preparation
...
from honeyos.tools.environments.base import BaseEnvironment
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"HONEYOS_EOF_{uuid.uuid4().hex[:8]}"
