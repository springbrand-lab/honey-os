...
# ``websockets`` is a direct honeyos-agent dependency because the browser CDP
...
def _resolve_cdp_endpoint() -> str:
    ...
    """
    try:
        from honeyos.tools.browser_tool import _get_cdp_override  # type: ignore[import-not-found]
...
def _browser_cdp_private_guard(
    *,
    ...
    """
    try:
        from honeyos.tools import browser_tool as bt  # type: ignore[import-not-found]
...
def _browser_cdp_check() -> bool:
    ...
    """
    try:
        from honeyos.tools.browser_tool import (  # type: ignore[import-not-found]
