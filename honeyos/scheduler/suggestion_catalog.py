...
These are the built-in automations HoneyOS can offer a new user out of the box —
    ...
    CatalogEntry(
        ...
        job_spec={
            "prompt": (
                ...
                "--threshold 7 --criteria ...` from the honeyos-agent install — "
...
def seed_catalog_suggestions(
    *,
    ...
    """
    if add_fn is None:
        from honeyos.scheduler.suggestions import add_suggestion as add_fn  # type: ignore[assignment]
