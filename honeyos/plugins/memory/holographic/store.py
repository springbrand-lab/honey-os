...
Single-user HoneyOS memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_honeyos_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted HONEYOS_HOME (same issue as
        # state.db / kanban.db — see honeyos.core.state._WAL_INCOMPAT_MARKERS).
    ...
    def search_facts(
        ...
        with self._lock:
            ...
            from honeyos.plugins.memory.holographic.retrieval import FactRetriever
