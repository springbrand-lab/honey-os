...
# When the user hasn't picked a reasoning effort, HoneyOS passes
...
# ON at this effort — matching the "medium (default)" that HoneyOS' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map HoneyOS' effort vocabulary onto Solar's accepted set. xhigh/max/
