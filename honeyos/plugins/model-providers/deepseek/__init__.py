...
the contract that subsequent turns echo it back; combined with how HoneyOS
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; HoneyOS remaps
the retired IDs in ``honeyos.runtime.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave HoneyOS, so they are not listed here.
    """
