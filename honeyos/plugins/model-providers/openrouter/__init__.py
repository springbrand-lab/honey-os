...
from honeyos.agent.transports.codex import _cache_scope_from_session_id
...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by honeyos.runtime/models.py
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See honeyos-agent#42991 (disable case)
            ...
            # live token-spend probe in honeyos-agent#43432). Route the existing
