...
from honeyos.gateway.platforms.helpers import redact_phone, strip_markdown
...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> HoneyOS gateway adapter.

    Each inbound phone number gets its own HoneyOS session (multi-tenant).
...
# static dict in honeyos.runtime/gateway.py, and the _send_sms dispatch in
