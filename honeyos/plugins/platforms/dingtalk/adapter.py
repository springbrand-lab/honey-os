...
from honeyos.gateway.platforms.helpers import MessageDeduplicator, compile_mention_patterns
...
class DingTalkAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        payload = {
            "msgtype": "markdown",
            "markdown": {"title": "HoneyOS", "text": normalized},
        }
    ...
    async def _create_and_stream_card(
        ...
        *,
        ...
        try:
            ...
            out_track_id = f"honeyos_{uuid.uuid4().hex[:12]}"
...
# dict in honeyos.runtime/gateway.py, and the _send_dingtalk dispatch in
...
async def _standalone_send(
    ...
    *,
    ...
    try:
        ...
        try:
            from honeyos.tools.send_message_tool import _error as _redact_error
...
def interactive_setup() -> None:
    ...
    Replaces honeyos.runtime/setup.py-era _setup_dingtalk + the static
    _PLATFORMS["dingtalk"] dict in honeyos.runtime/gateway.py. CLI helpers are
    ...
    if method == 0:
        try:
            from honeyos.runtime.dingtalk_auth import dingtalk_qr_auth
