...
required — uses aiohttp which is already a HoneyOS dependency.
        ...
        for fid in file_ids:
            try:
                ...
                async with self._session.get(
                    ...
                    if resp.status < 400:
                        file_data = await resp.read()
                        from honeyos.gateway.platforms.base import cache_image_from_bytes, cache_document_from_bytes
...
def interactive_setup() -> None:
    ...
    ``honeyos.runtime/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where HoneyOS delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # honeyos.runtime/setup.py::_setup_mattermost function.
