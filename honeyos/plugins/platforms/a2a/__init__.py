"""
A2A (Agent-to-Agent) plugin for HoneyOS.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes HoneyOS as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`honeyos gateway setup` flow for A2A."""
    ...
    print_info("Expose HoneyOS as an A2A-discoverable agent and call other A2A agents.")
