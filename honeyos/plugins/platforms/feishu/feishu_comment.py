...
def _resolve_model_and_runtime() -> Tuple[str, dict]:
    ...
    from honeyos.gateway.run import _resolve_runtime_agent_kwargs
...
def _run_comment_agent(prompt: str, client: Any, session_key: str = "") -> str:
    ...
    from honeyos.tools.feishu_doc_tool import set_client as set_doc_client
    from honeyos.tools.feishu_drive_tool import set_client as set_drive_client
...
async def handle_drive_comment_event(
    ...
    # Access control
    from honeyos.plugins.platforms.feishu.feishu_comment_rules import load_config, resolve_rule, is_user_allowed, has_wiki_keys
