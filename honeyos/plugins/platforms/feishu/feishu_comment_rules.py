...
Config: ~/.honeyos/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.honeyos/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_honeyos_home()`` helper (HONEYOS_HOME-aware and
...
RULES_FILE = get_honeyos_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_honeyos_home() / "feishu_comment_pairing.json"
