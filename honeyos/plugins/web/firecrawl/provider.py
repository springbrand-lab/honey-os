...
def _get_firecrawl_gateway_url() -> str:
    ...
    import honeyos.tools.web_tools as _wt
...
def check_firecrawl_api_key() -> bool:
    ...
    existing tests and the ``honeyos tools`` setup flow.
    """
...
def _raise_web_backend_configuration_error() -> None:
    ...
    if _wt.managed_nous_tools_enabled():
        message += (
            ...
            "run `honeyos tools` and select Nous Subscription as the web provider."
        )
    else:
