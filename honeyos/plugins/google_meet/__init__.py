...
from honeyos.plugins.google_meet.cli import register_cli as _register_meet_cli
from honeyos.plugins.google_meet.cli import meet_command as _meet_command
from honeyos.plugins.google_meet.tools import (
    MEET_JOIN_SCHEMA,
    MEET_LEAVE_SCHEMA,
    MEET_SAY_SCHEMA,
    MEET_STATUS_SCHEMA,
...
def register(ctx) -> None:
    ...
    ctx.register_cli_command(
        ...
        description=(
            "Let the honeyos agent join a Google Meet call and scrape live "
            "captions into a transcript. See: honeyos meet setup"
        ),
    )
