"""Native Spotify tools for HoneyOS (registered via plugins/spotify)."""
...
from honeyos.plugins.spotify.client import (
    SpotifyAPIError,
...
from honeyos.tools.registry import tool_error, tool_result
