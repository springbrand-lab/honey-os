...
from honeyos.agent.auxiliary_client import async_call_llm, extract_content_or_reasoning
...
from honeyos.plugins.teams_pipeline.models import (
    MeetingArtifact,
    TeamsMeetingPipelineJob,
    TeamsMeetingRef,
    TeamsMeetingSummaryPayload,
)
from honeyos.plugins.teams_pipeline.store import TeamsPipelineStore
...
class TeamsMeetingPipeline:
    ...
    async def _transcribe_recording(
        ...
        temp_root = self.config.tmp_dir or (get_honeyos_home() / "tmp" / "teams_pipeline")
