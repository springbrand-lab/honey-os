...
discovery — no hardcoded model ids, so retired models drop out of honeyos the
...
from honeyos.agent.video_gen_provider import OpenAICompatibleVideoGenProvider
