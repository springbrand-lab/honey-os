...
from honeyos.agent.models_dev import ModelInfo
...
class ExpensiveModelWarning:
    """Confirmation payload for models above HoneyOS' cost guardrail."""
...
def expensive_model_warning(
    ...
    *,
    ...
    lines = [
        ...
        "",
        f"{model} has known pricing above HoneyOS' safety threshold.",
