"""Prompt-size diagnostic: ``honeyos prompt-size``.
...
def compute_prompt_breakdown(platform: str = "cli") -> Dict[str, Any]:
    ...
    """
    from honeyos.agent.system_prompt import build_system_prompt, build_system_prompt_parts
...
def cmd_prompt_size(args: Any) -> None:
    """Entry point for ``honeyos prompt-size``."""
