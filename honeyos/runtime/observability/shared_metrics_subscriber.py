"""Relay subscriber for the persisted HoneyOS shared-metrics slice."""
...
from honeyos.agent.relay_runtime import RUNTIME_INSTANCE_KEY
...
class SharedMetricsSubscriber:
    """Persist validated HoneyOS counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the HoneyOS shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
