...
``cli.py``'s ``HoneyOSCLI`` class. ``HoneyOSCLI`` inherits ``CLICommandsMixin`` so
...
from honeyos.core.constants import display_honeyos_home, is_termux as _is_termux_environment
from honeyos.agent.turn_context import extract_api_content_sidecar
from honeyos.runtime.browser_connect import (
...
class CLICommandsMixin:
    ...
    def _handle_rollback_command(self, command: str):
        ...
        """
        from honeyos.tools.checkpoint_manager import format_checkpoint_list
        ...
        if not mgr.enabled:
            ...
            print("  Enable with: honeyos --checkpoints")
    ...
    def _handle_diff_command(self, command: str):
        ...
        Syntax:
            ...
            /diff session          — everything HoneyOS changed (checkpoint baseline)
    ...
    def _print_session_diff(self, cwd: str, stat_only: bool):
        ...
        if result.get("empty") or (not stat and not diff):
            print("  No changes — HoneyOS hasn't edited any files here yet.")
            return
    ...
    def _handle_snapshot_command(self, command: str):
        """Handle /snapshot — lightweight state snapshots for HoneyOS config/state.
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_honeyos_home()}/state-snapshots/):\n")
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from honeyos.runtime.profiles import export_profile, get_active_profile_name
        ...
        try:
            ...
            print("  Share it: the other user runs /import or `honeyos profile import <archive>`.")
    ...
    def _handle_import_command(self, command: str):
        ...
        try:
            ...
            pass
        print(f"  Use it: honeyos -p {imported}")
    ...
    def _handle_stop_command(self):
        ...
        try:
            from honeyos.tools.async_delegation import active_count, interrupt_all
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        """Handle /journey — the learning timeline (see `honeyos journey`).
        ...
        from cli import _cprint
        from honeyos.runtime.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from honeyos.runtime.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        try:
            from honeyos.runtime.clipboard import (
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run honeyos chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in honeyos.runtime/colors.py
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        if not pcfg or not pcfg.enabled:
            ...
            relay_fronts = False
            try:
                from honeyos.gateway.relay import relay_platform_identities
        ...
        try:
            ...
            pass
        _cprint("  Timed out waiting for the gateway. Is `honeyos gateway` running?")
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not target:
            ...
            if self._show_recent_sessions(reason="resume"):
                ...
                return
            _cprint("  Tip:   Use /history or `honeyos sessions list` to find sessions.")
            return
        ...
        if target.isdigit():
            ...
            from honeyos.runtime.main import _resolve_session_by_name_or_id
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `honeyos sessions list` to see available sessions.")
            return
        ...
        # same directory as a startup `honeyos -c`/`--resume`. The startup resume
    ...
    def _handle_branch_command(self, cmd_original: str) -> None:
        ...
        try:
            self._session_db.create_session(
                ...
                source=os.environ.get("HONEYOS_SESSION_SOURCE", "cli"),
                model=self.model,
                model_config={
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        """
        from honeyos.agent.pet import store
        from honeyos.agent.pet.manifest import ManifestError
        from honeyos.runtime.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        """
        from honeyos.agent.pet import store
        from honeyos.agent.pet.generate import orchestrate
        from honeyos.agent.pet.generate.imagegen import GenerationError
        from honeyos.runtime.pets import _set_active
    ...
    def _handle_cron_command(self, cmd: str):
        ...
        import shlex
        from honeyos.tools.cronjob_tools import cronjob as cronjob_tool
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from honeyos.runtime.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from honeyos.runtime.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to honeyos.runtime.curator so the CLI and the `honeyos curator`
        ...
        try:
            from honeyos.runtime.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to honeyos.runtime.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from honeyos.runtime.skills_hub import handle_skills_slash
    ...
    def _handle_learn_command(self, cmd: str):
        ...
        """
        from honeyos.agent.learn_prompt import build_learn_prompt
    ...
    def _handle_init_command(self, cmd: str):
        ...
        """
        from honeyos.runtime.init_command import build_init_prompt_for_cwd
    ...
    def _handle_background_command(self, cmd: str):
        ...
        def run_background():
            ...
            try:
                ...
                if response:
                    try:
                        from honeyos.runtime.skin_engine import get_active_skin
                        _skin = get_active_skin()
                        label = _skin.get_branding("response_label", "⚕ HoneyOS")
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        Mirrors ``honeyos bundles list`` but renders inside the running
        ...
        if not bundles:
            ...
            _cprint(
                f"  {_DIM}Create one with: honeyos bundles create "
        ...
        _cprint(
            ...
            f"Manage with `honeyos bundles`.{_RST}"
        )
    ...
    def _handle_browser_command(self, cmd: str):
        ...
        if sub.startswith("connect"):
            ...
            try:
                from honeyos.tools.browser_tool import cleanup_all_browsers
            ...
            try:
                from honeyos.tools.browser_tool import _ensure_cdp_supervisor  # type: ignore[import-not-found]
            ...
            if hasattr(self, '_pending_input'):
                self._pending_input.put(
                    ...
                    "just because CDP is connected. This is typically a HoneyOS-managed isolated debug "
            ...
            if current:
                ...
                try:
                    from honeyos.tools.browser_tool import cleanup_all_browsers, _stop_cdp_supervisor
            ...
            if current:
                ...
                try:
                    from honeyos.tools.browser_tool import _get_cloud_provider
                ...
                if provider is not None:
                    ...
                    try:
                        from honeyos.tools.browser_tool import _get_browser_engine
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        cross-process schedules use `honeyos cron`.
        """
        from cli import _DIM, _RST, _cprint
        from honeyos.runtime.heartbeat import parse_interval, format_interval
        ...
        if interval is None:
            ...
            return
        if interval < 0:
            from honeyos.runtime.heartbeat import MIN_INTERVAL_SECONDS
        ...
        _cprint(
            ...
            f"lives only while this HoneyOS process runs — use `honeyos cron` for "
    ...
    def _handle_goal_command(self, cmd: str) -> None:
        ...
        _cprint(
            ...
            f"HoneyOS keeps working until it is, you pause/clear it, or the budget is "
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from honeyos.runtime.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_honeyos_home()}/skins/\n")
            return
    ...
    def _compose_in_editor(self, initial_text: str = "") -> str:
        ...
        fd, path = tempfile.mkstemp(suffix=".md", prefix="honeyos_prompt_")
        try:
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        from honeyos.runtime.colors import Colors as _Colors
        from honeyos.runtime.focus_view import (
            FOCUS_CONFIG_KEY,
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from honeyos.runtime.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from honeyos.runtime.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from honeyos.runtime.focus_view import format_hidden_line
    ...
    def _handle_busy_command(self, cmd: str):
        """Handle /busy — control what Enter does while HoneyOS is working.
        ...
        if save_config_value("display.busy_input_mode", arg):
            if arg == "queue":
                behavior = "Enter will queue follow-up input while HoneyOS is busy."
            elif arg == "steer":
                behavior = "Enter will steer your message into the current run (after the next tool call)."
            else:
                behavior = "Enter will redirect the current run while HoneyOS is busy; /stop still cancels it."
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        """
        from cli import _ACCENT, _DIM, _RST, _cprint, save_config_value
        from honeyos.core.constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from honeyos.runtime.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
    ...
    def _handle_debug_command(self, cmd_original: str = ""):
        ...
        """
        from honeyos.runtime.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        """Handle /update — update HoneyOS to the latest version.

        In the classic CLI this exits the session and relaunches as
        ``honeyos update`` so the user sees update output directly and gets
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update HoneyOS')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update HoneyOS"),
            ("cancel", "Cancel", "keep the current session"),
        ]
        raw = self._prompt_text_input_modal(
            title="⚕  Update HoneyOS",
            detail="This will exit the current session and run `honeyos update`.",
            choices=choices,
        )
        if raw is None:
    ...
    def _handle_wake_command(self, command: str):
        """Handle /wake [on|off|status] — the 'Hey HoneyOS' hotword listener.
    ...
    def _persist_wake_word_enabled(self, enabled: bool):
        ...
        try:
            from honeyos.tools.wake_word import load_wake_word_config
