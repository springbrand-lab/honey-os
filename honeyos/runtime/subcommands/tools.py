"""``honeyos tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'honeyos tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # honeyos tools list [--platform cli]
    ...
    # honeyos tools disable <name...> [--platform cli]
    ...
    # honeyos tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `honeyos tools` runs after you pick a provider that\n"
