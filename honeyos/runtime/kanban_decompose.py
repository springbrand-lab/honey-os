...
Invoked by ``honeyos kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the HoneyOS board.
...
def _profile_author() -> str:
    """Mirror of ``honeyos.runtime.kanban._profile_author``."""
    return (
