"""Client for uploading ``honeyos debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``honeyos debug share``.
...
NAS_BASE = os.environ.get(
    "HONEYOS_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "honeyos-agent/debug-share"
