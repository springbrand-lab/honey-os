...
Entry point: ``honeyos whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``honeyos.runtime/main.py``).
...
HoneyOS gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures HoneyOS to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  HoneyOS needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the HoneyOS gateway in another terminal:")
    print("         honeyos gateway")
    print()
    ...
    print()
    print("  Docs: https://honeyos-agent.nousresearch.com/docs/user-guide/")
