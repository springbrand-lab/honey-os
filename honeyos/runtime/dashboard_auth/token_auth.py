...
How it fits the existing auth framework:
  ...
  * :func:`token_auth_middleware` runs OUTERMOST (installed last in
    ...
    :class:`~honeyos.runtime.dashboard_auth.base.TokenPrincipal` to
...
from honeyos.runtime.dashboard_auth import list_token_providers
from honeyos.runtime.dashboard_auth.audit import AuditEvent, audit_log
from honeyos.runtime.dashboard_auth.base import ProviderError, TokenPrincipal
