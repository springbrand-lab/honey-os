"""
Skills configuration for HoneyOS.
`honeyos skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.honeyos/config.yaml under:
...
from honeyos.runtime.config import cfg_get, load_config, save_config
from honeyos.runtime.colors import Colors, color
from honeyos.runtime.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `honeyos skills`."""
    from honeyos.runtime.curses_ui import curses_checklist
