...
def match_blueprint(query: str) -> Tuple[Optional[Any], List[Any]]:
    ...
    """
    from honeyos.scheduler.blueprint_catalog import CATALOG, get_blueprint
...
def _humanize_schedule(blueprint) -> str:
    from honeyos.scheduler.blueprint_catalog import _humanize_schedule as _h
...
def build_blueprint_seed(blueprint) -> str:
    ...
    """
    from honeyos.scheduler.blueprint_catalog import WEEKDAY_PRESETS
...
def _fmt_catalog() -> str:
    from honeyos.scheduler.blueprint_catalog import CATALOG
...
def handle_blueprint_command(
    ...
    *,
    ...
    """
    try:
        from honeyos.scheduler.blueprint_catalog import fill_blueprint, BlueprintFillError
