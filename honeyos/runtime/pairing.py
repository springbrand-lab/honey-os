...
Usage:
    honeyos pairing list              # Show all pending + approved users
    honeyos pairing approve <platform> <request-id|code>  # Approve a pairing request
    honeyos pairing revoke <platform> <user_id> # Revoke user access
    honeyos pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle honeyos pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: honeyos pairing {list|approve|revoke|clear-pending}")
        print("Run 'honeyos pairing --help' for details.")
...
def _cmd_list(store):
    ...
    if pending:
        ...
        print("\n  Approve with: honeyos pairing approve <platform> <request-id>")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.honeyos/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Pairing request or code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'honeyos pairing list' to see pending requests.\n")
